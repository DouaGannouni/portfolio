        ...
        <div className="timeline-item timeline-animate">
          ...
          <div className="timeline-content timeline-content-flex">
            ...
            <div>
              ...
              <div className="timeline-title">Engineering degree in Software Engineering</div>
            </div>
          </div>
        </div>
        <div className="timeline-item timeline-animate">
          ...
          <div className="timeline-content timeline-content-flex">
            ...
            <div>
              ...
              <div className="timeline-title">1st year Master in IoT Services Development</div>
            </div>
          </div>
        </div>
        <div className="timeline-item timeline-animate">
          ...
          <div className="timeline-content timeline-content-flex">
            ...
            <div>
              <div className="timeline-school">ISET Mahdia</div>
              <div className="timeline-title">Bachelor in Information Technology, Information Systems Development</div>
            </div>
          </div>
        </div>
      </div>
